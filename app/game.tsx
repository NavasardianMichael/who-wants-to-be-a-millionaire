      ...
      <View className='flex flex-col gap-4 mt-auto text-secondary'>
        ...
        <View className='flex flex-col gap-2'>
          <View className='flex-row gap-2'>
            <TouchableHighlight className='flex-1 border border-secondary rounded-md py-sm px-md'>
              <View className='flex-row gap-1'>
                <Text className='color-tertiary font-semibold'>A. </Text>
                <Text className='text-secondary'>Answer 1</Text>
              </View>
            </TouchableHighlight>
            <TouchableHighlight className='flex-1 border border-secondary rounded-md py-sm px-md'>
              <View className='flex-row gap-1'>
                <Text className='color-tertiary font-semibold'>B. </Text>
          ...
          <View className='flex-row gap-2'>
            <TouchableHighlight className='flex-1 border border-secondary rounded-md py-sm px-md'>
              <View className='flex-row gap-1'>
                <Text className='color-tertiary font-semibold'>C. </Text>
                <Text className='text-secondary'>Answer 3</Text>
              </View>
            </TouchableHighlight>
            <TouchableHighlight className='flex-1 border border-secondary rounded-md py-sm px-md'>
              <View className='flex-row gap-1'>
                <Text className='color-tertiary font-semibold'>D. </Text>
